...
if(!is_array($motbaiviet)){
    ...
    $mota = $motbaiviet['mota'];
    $tacgia = $motbaiviet['tacgia'];
    $date = $motbaiviet['date'];
    $date = explode(" ",$date);
                ...
                <aside class="col-md-3 col-sm-4">
                    <div class="main-sidebar">
                            ...
                            <div class="panel-group">
                                <?php foreach ($showDmBlog as $motdm) { 
                                    ...
                                    <div class="cate-heading">
                                        <a href="?act=blog&maloai='.$motdm['id'].'&Page=1" class="collapsed"> '.$motdm['name'].'
                                        </a>
                                    </div>
                                </div>';
                                }?>
                        ...
                        <div id="goshop_widget_posts-2" class="widget sidebar-widget goshop_widget_posts clearfix">
                            <h6 class="widget-title">Có Thể Bạn Thích</h6>
                        ...
                        <div class="widget widget-flickr-feed clearfix">
                            ...
                            <ul>
                                <li> <a href="#"> <img src="views/img/flicker/1.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                                <li> <a href="#"> <img src="views/img/flicker/2.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                                <li> <a href="#"> <img src="views/img/flicker/3.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>

                                <li> <a href="#"> <img src="views/img/flicker/4.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                                <li> <a href="#"> <img src="views/img/flicker/5.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                                <li> <a href="#"> <img src="views/img/flicker/6.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>

                                <li> <a href="#"> <img src="views/img/flicker/7.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                                <li> <a href="#"> <img src="views/img/flicker/8.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                                <li> <a href="#"> <img src="views/img/flicker/9.jpg"
                                            style="width:80px; object-fit: cover;" alt=""> </a> </li>
                            </ul>
                        </div>
                    </div>
                ...
                <main class="col-md-9 col-sm-8 blog-wrap">
                    <article class="post type-post format-standard has-post-thumbnail" itemscope="itemscope"
                        ...
                        <div class="entry-media">
                            <img src="<?=$imgavt?>" alt="" itemprop="image"
                            ...
                            <div class="media-body">
                                <header class="entry-header">
                                    ...
                                    <h3 class="entry-title" itemprop="headline">
                                        <a href="single.html" rel="bookmark" itemprop="url"><strong><?=$name?></strong></a>
                                    </h3>
                                </header>
